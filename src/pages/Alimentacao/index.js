...
export default function Alimentacao(props) {
  ...
  return (
    <KeyboardAvoidingView style={styles.background}>
      ...
      <Text style={styles.texsubtitle4}>Digite 7 para porte pequeno</Text>
      <Text style={styles.texsubtitle4}>Digite 5 para porte medio</Text>
      <Text style={styles.texsubtitle4}>Digite 3 para porte grande</Text>
